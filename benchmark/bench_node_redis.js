...
suite.add('JS PARSER BUF: : integer', function () {
  parserBuffer.execute(integerBuffer)
})

// BIG INTEGER

suite.add('JS PARSER BUF: : big integer', function () {
  parserBuffer.execute(bigIntegerBuffer)
})
...
suite.add('JS PARSER BUF: - error', function () {
  parserBuffer.execute(errorBuffer)
})
